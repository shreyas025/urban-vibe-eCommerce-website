      ...
      <div className="flex flex-col justify-center sm:flex-row gap-10 my-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-4">
          ...
          <p className="text-gray-800">
            Tel: <span className="text-gray-500">+91 7796429896</span>
          </p>
          <p className=" text-gray-800">
            Email: <span className="text-gray-500">urbanvibe1503@gmail.com</span>
          </p>

          <p className="text-gray-500">Careers at Urban Vibe</p>
